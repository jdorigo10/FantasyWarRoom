        ...
        <div className="grid grid-cols-12 gap-0 px-2 py-2 bg-[#161b22] text-[11px] font-bold text-[#8b949e] uppercase tracking-tighter border-b border-[#30363d]">
          ...
          {showExtendedStats && (
            <>
              ...
              <div className="col-span-1 text-center ml-2">TAGS</div>
            </>
          )}
          {!showExtendedStats && (
            <>
                    ...
                    <TooltipProvider>
                      <Tooltip delayDuration={0}>
                        <TooltipTrigger asChild>
                          <div className="flex justify-center gap-0 cursor-help hover:bg-white/5 rounded transition-colors w-full h-full min-h-[20px] items-center">
